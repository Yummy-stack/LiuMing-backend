package com.liumingservices.ai.love.chat;


import com.alibaba.cloud.ai.dashscope.chat.DashScopeChatModel;
import com.liumingservices.ai.love.advisors.LoggerAdvisor;
import com.liumingservices.ai.love.advisors.ReReadingAdvisor;
...
public class LoveAiChat {
    ...
    public LoveAiChat(DashScopeChatModel dashscopeChatModel, Advisor loveCloudAdvisor, VectorStore loveVectorStore) {
        this.dashscopeChatModel = dashscopeChatModel;
        this.loveCloudAdvisor = loveCloudAdvisor;
        this.loveVectorStore = loveVectorStore;
